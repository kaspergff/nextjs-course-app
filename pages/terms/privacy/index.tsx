...
const Privacy = () => {
  return (
    <Layout>
      ...
      <p>
        Your privacy is important to us. It is web3dev&#39;s policy to respect
        ...
        website, <a href="https://web3dev.com">https://web3dev.com</a>, and
        other sites we own and operate.{" "}
      </p>
      <p>
        This policy is effective as of 8 February 2022 and was last updated on 8
        February 2022.{" "}
      </p>
      ...
      <h4 className="font-bold text-md">Log Data</h4>
      <p>
      ...
      <h4 className="font-bold text-md">Legitimate Reasons for Processing Your Personal Information</h4>
      <p>
      ...
      <h4 className="font-bold text-md">Collection and Use of Information</h4>
      <p>
      ...
      <h4 className="font-bold text-md">Security of Your Personal Information</h4>
      <p>
      ...
      <h4 className="font-bold text-md">How Long We Keep Your Personal Information</h4>
      <p>
      ...
      <h3 className="font-bold text-lg">Children’s Privacy</h3>
      <p>
      ...
      <h3 className="font-bold text-lg">International Transfers of Personal Information</h3>
      <p>
      ...
      <h3 className="font-bold text-lg">Your Rights and Controlling Your Personal Information</h3>
      <p>
      ...
      <h3 className="font-bold text-lg">Use of Cookies</h3>
      <p>
      ...
      <h3 className="font-bold text-lg">Limits of Our Policy</h3>
      <p>
      ...
      <h3 className="font-bold text-lg">Changes to This Policy</h3>
      <p>
